...
main.road_map.add_road([[150,10,100],[130,150]])
...
test_end = [150,140]
test_rad = -50
# Tools.draw_double_arc(main.globals,main.globals.VEHICLE_SURFACE,test_start,test_end,test_rad,.5,Colors.CAR_GREEN_LINE) # 1*3.66
